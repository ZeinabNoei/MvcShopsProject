...
namespace MyEShop.Areas.Admin.Controllers
{
    public class FeaturesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FeatureID,FeatureTitle,RecordDate,ModificationDate")] Features features)
        {
            if (ModelState.IsValid)
            {
                db.Features.Add(features);
                features.RecordDate = DateTime.Now;
                features.ModificationDate = DateTime.Now;
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FeatureID,FeatureTitle,RecordDate,ModificationDate")] Features features)
        {
            if (ModelState.IsValid)
            {
